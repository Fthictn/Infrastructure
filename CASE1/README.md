...
`$ couchbase-cli rebalance -c 127.0.0.1:8065 --username Administrator --password 123456` nodelar arasındaki rebalancing işlemi gerçekleştirilir.
    ...
    #Docker engine **Not:** Couchbase cli komutları docker exec komutuyla kullanılabileceği gibi windows için **C:\Program Files\Couchbase\Server\bin>** dizini altında da çalıştırılabilir.
